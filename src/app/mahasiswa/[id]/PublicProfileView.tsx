        ...
        >
          ...
          <div className="w-full max-w-5xl mx-auto px-6 md:px-12 pb-20 flex-1 flex flex-col">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 -mt-16 sm:-mt-20 mb-8 relative z-10">
              ...
              {/* Action Buttons — "Kirim Email" menggantikan "Edit Profil" */}
              <div className="flex flex-wrap items-center gap-2 pb-2">
                <a
                  href={`mailto:${mahasiswa.contact_email || mahasiswa.email}`}
                  className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-secondary text-white font-bold text-sm hover:bg-secondary/90 transition-all shadow-md"
                >
                  <FiSend size={16} />
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-5 py-2.5 rounded-xl font-bold text-sm border-2 border-primary text-primary bg-surface hover:bg-primary hover:text-white transition-all shadow-sm"
                >
                  <FiShare2 size={16} />
            ...
            <p className="text-on-surface-variant text-[15px] leading-relaxed mb-8 bg-surface-variant/30 p-5 md:p-6 rounded-2xl border border-outline-variant/20 shadow-sm">
              {mahasiswa.bio || "Halo! Saya mahasiswa BEM STMIK Tazkia. Saya siap untuk berkolaborasi dan menciptakan karya-karya inovatif."}
            </p>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 mb-6 border-b-2 border-outline-variant/30">
              <div className="flex items-center gap-3 font-bold text-base text-primary">
                <FiFolder size={20} />
                <span>Proyek & Repository Publik ({projects.length})</span>
              </div>
              {projects.length > 0 && (
                <div className="flex flex-wrap gap-2">
